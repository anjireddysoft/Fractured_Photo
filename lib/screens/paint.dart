...
class _CustomState extends State<Custom> {
                  ...
                  child: GestureDetector(
                    ...
                    child: Transform.translate(
                      ...
                      child: CustomPaint(
                        ...
                        painter:
                            ShatteredPuzzleCanvas(droppedTilesList, isRotated),
                      ),
                    ),
                  ),
                ),
  ...
  Future<void> onPanStart(DragStartDetails details) async {
    ...
    for (int i = 0; i < droppedTilesList.length; ++i) {
      ...
      final pngBytes =
          await tile.imageObject!.toByteData(format: ImageByteFormat.png);
